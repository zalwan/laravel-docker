@if ($paginator->hasPages())
    <nav class="d-flex flex-column align-items-center gap-2" aria-label="Pagination Navigation">
        ...
        <ul class="pagination justify-content-center mb-0 d-none d-sm-flex">
            @if ($paginator->onFirstPage())
